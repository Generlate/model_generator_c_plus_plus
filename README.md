...
![GitHub release (latest by date)](https://img.shields.io/github/v/release/Generlate/model_generator_c_plus_plus) ![Repo size](https://img.shields.io/github/repo-size/Generlate/model_generator_c_plus_plus)
<br>
